...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL",
    "Jay music distribution Support <support@jay-music-distribut-48920.botics.co>",
)
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = (
        "jay_music_distribut_48920.storage_backends.AzureMediaStorage"
    )
    STATICFILES_STORAGE = (
        "jay_music_distribut_48920.storage_backends.AzureStaticStorage"
    )
